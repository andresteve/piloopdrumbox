...
public:
	...
	Keypad(String *userKeymap, byte *row, byte *col, byte numRows, byte numCols);
...
public:
	...
	bool getKeys();
	KeyState getState();
	void begin(String *userKeymap);
	void setDebounceTime(uint);
	void setHoldTime(uint);
	void addEventListener(void (*listener)(String));
	void addStatedEventListener(void (*listener)(String, KeyState));
	int findInList(String keystr);
...
private:
	...
	void (*keypadEventListener)(String);
	void (*keypadStatedEventListener)(String, KeyState);
};
