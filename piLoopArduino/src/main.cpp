...
Track loopTracks[] ={Track(0, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(1, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(2, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(3, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(4, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(5, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(6, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2),
                     Track(7, TRACK_VOL_ANALOG_IN, TRACK_VOL_MUX_S0, TRACK_VOL_MUX_S1, TRACK_VOL_MUX_S2)};


Looper looper = Looper(&drumpadKeypad, &trackpadKeypad, loopTracks, &tft, leds, &muteKey, &Serial1, SERIAL_TO_PI_BAUD_RATE); 
